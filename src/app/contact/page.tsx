      ...
      <section className="py-16 md:py-20 bg-[#f3f7fb]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-[1.1fr,0.9fr] gap-10 items-start">
          ...
          <div className="bg-white rounded-2xl shadow-md p-8">
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#016B61] mb-4">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <select className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#016B61] focus:border-transparent bg-slate-50">
          ...
          <div className="space-y-6">
            <div className="bg-[#016B61] text-white rounded-2xl p-8 shadow-md">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md space-y-4 text-sm text-slate-700">
              <h4 className="text-base font-extrabold text-[#016B61]">Business Hours</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md space-y-4 text-sm text-slate-700">
              <h4 className="text-base font-extrabold text-[#016B61]">Head Office</h4>
