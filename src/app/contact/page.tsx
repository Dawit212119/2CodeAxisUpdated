          ...
          <div className="bg-white rounded-2xl shadow-md p-8">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <select className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#ea8c06] focus:border-transparent bg-slate-50">
