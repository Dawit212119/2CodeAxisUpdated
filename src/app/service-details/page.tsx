...
const servicesData: Record<string, { title: string; description: string; body: string; image: string }> = {
  "software-development": {
    ...
    description:
      "At GenShifter Technologies, we offer a comprehensive range of software development solutions tailored to meet your unique business needs and drive growth through innovative technology and industry expertise.",
    body:
  ...
  "managed-services": {
    ...
    description:
      "At GenShifter Technologies, our Managed Services are designed to ensure your business operates smoothly and securely. We offer a comprehensive suite of services that includes IT Support and Helpdesk, Managed Network Services, Managed Security Services, and Managed Cloud Services.",
    body:
  ...
  "infrastructure-services": {
    ...
    description:
      "At GenShifter Technologies, we provide a full range of Infrastructure Services designed to optimize and enhance your IT infrastructure.",
    body:
  ...
  "system-integration": {
    ...
    description:
      "At GenShifter Technologies, our System Integration services are designed to provide seamless connectivity and enhance the efficiency of your IT environment.",
    body:
  ...
  "training-development": {
    ...
    description:
      "At GenShifter Technologies, our Training and Development services are designed to empower your team with the knowledge and skills needed to leverage your technology effectively.",
    body:
  ...
  "cybersecurity-services": {
    ...
    description:
      "At GenShifter Technologies, our Cybersecurity Services are designed to provide robust protection against digital threats and ensure the safety of your critical data and systems.",
    body:
